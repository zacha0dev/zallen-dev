...
It is a small piece of cloud the AI can run, fix, and extend by itself, inside a
box it cannot escape and a budget it cannot blow (about $10/month, capped). You
deploy your own, point your assistant at it, and poke around.
...
That is the whole trick. What matters is *which tools* you put behind it.
...
a feature, and it edits its code, ships it, and then uses what it just built.
...
- **A hard cap.** About $10/month by default, with alerts and an automatic
